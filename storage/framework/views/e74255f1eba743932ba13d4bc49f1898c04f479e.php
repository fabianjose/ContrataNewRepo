	...
	<div class="d-flex  align-items-end w-100 nosotros-title p-5">
			...
			<div class="container">
				...
				<div class="row justify-content-center align-items-center ">
									...
									<div class="col-12 col-sm-8 text-center">
										...
										<h1 class="titulo-nosotros" >   
											...
											<div class="offer-card-separator bg-main-pink" style="height: 3px;" ></div>
									...
									<div class="col-12 col-sm-4">
											<div>
											<img src="<?php echo e(url('./images/Porque-contrataInternet.jpg')); ?>" class="img-fluid" >
											</div>
									</div>
				</div>
				<br><br><br>
				...
				<div class="row justify-content-center align-items-center ">
											...
											<div class="col-12 col-sm-4 order-2 ">
													<div>
											<img src="<?php echo e(url('./images/Mision.jpg')); ?>" class="img-fluid" >
											</div>
											</div>
				...
				<div class="row justify-content-center align-items-center ">
						...
						<div class="col-12 col-sm-8 text-center">
							...
							<div class="offer-card-separator bg-main-blue" style="height: 3px;" ></div>
							...
							<div class="col-12 col-sm-4">
									<div>
									<img src="<?php echo e(url('images/Vision.jpg')); ?>" class="img-fluid" >
									</div>
							</div>
					</div>
		...
		<div class="d-flex flex-wrap justify-content-center mt-4 p-4">
			<div class="col-xl-4 col-lg-4 col-md-6 col-12 d-flex align-items-center justify-content-center p-2">
				<img src="<?php echo e(url('images/service-1.png')); ?>" class="img-nosotros-services">
			...
			<div class="col-xl-4 col-lg-4 col-md-6 col-12 d-flex align-items-center justify-content-center p-2">
				<img src="<?php echo e(url('images/service-222.png')); ?>" class="img-nosotros-services">
				<div class="pl-2 d-flex flex-column" style="text-align: center;">
			...
			<div class="col-xl-4 col-lg-4 col-md-6 col-12 d-flex align-items-center justify-content-center p-2">
				<img src="<?php echo e(url('images/service-3.png')); ?>" class="img-nosotros-services">
				<div class="pl-2 d-flex flex-column" style="text-align: center;">
			...
			<div class="col-xl-4 col-lg-4 col-md-6 col-12 d-flex align-items-center justify-content-center p-2">
				<img src="<?php echo e(url('images/service-4.png')); ?>" class="img-nosotros-services">
				<div class="pl-2 d-flex flex-column" style="text-align: center;">
			...
			<div class="col-xl-4 col-lg-4 col-md-6 col-12 d-flex align-items-center justify-content-center p-2">
				<img src="<?php echo e(url('images/service-5.png')); ?>" class="img-nosotros-services">
				<div class="pl-2 d-flex flex-column" style="text-align: center;">
...
<?php echo $__env->make("layouts.landing", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/remotepc/contratainternet.co/resources/views/pages/nosotros.blade.php ENDPATH**/ ?>