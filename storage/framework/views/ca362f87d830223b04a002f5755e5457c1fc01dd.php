        ...
        <nav id="nav-grande" class="  main-header navbar-light navbar navbar-expand-md mx-auto py-3 px-1 align-items-center header-posicion fixed-top" style="background-color:white; height: 80px;">
            <ul  class="navbar-nav ml-3 ">
                <a class="nav-item  " href="/"  style="margin-top: -22px;">
                    <img class="ic-logo" src="<?php echo e(asset('images/LOGO5COLORH258.png')); ?>"  alt="">
                </a>
            </ul>
            ...
            <div id="responsive-menu" class="navbar-collapse collapse ml-auto mr-0"  style="margin-top: 37px;">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link nav-item-border <?php echo e(strpos(Route::current()->uri,'blog')>-1?'active':''); ?>" href="/blog">
                            <h6 class="ic-main font-weight-bold  item-menu" >
                                Blog
                            </h6>
                        </a>
        ...
        <div class="footer-bg">
          <div class="d-flex flex-column align-items-center">
            ...
            <div class="d-flex w-100 flex-wrap justify-content-bewtween">
              ...
              <img src="<?php echo e(asset('images/fondo_azul_contrata.png')); ?>" class="img-responsive text-center" style="max-width: 65%;">
 ...
 <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cVKIPhGWiC2Al4u+LWgxfKTRIcfu0JTxR+EQDz/bgldoEyl4H0zUF0QKbrJ0EcQF" crossorigin="anonymous"></script>
  ...
  setTimeout(abc, 5000);
      ...
      function abc(){
        ...
        document.getElementById("btn-modal333").click();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\contratainternetDefinitivo(base)\resources\views/layouts/landing.blade.php ENDPATH**/ ?>