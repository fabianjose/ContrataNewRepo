...
<?php else: ?>
    <offers-filter :pagination="<?php echo e($pagination->toJson()); ?>" :fields="<?php echo e($fields); ?>" 
        ...
        :plans="<?php echo e(json_encode($plans)); ?>">
    </offers-filter>
<?php endif; ?>

<?php $__env->stopSection(); ?>
				
<?php echo $__env->make("layouts.landing", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/djmbdv/fabian/contrataNewRepo/resources/views/pages/planComparator.blade.php ENDPATH**/ ?>